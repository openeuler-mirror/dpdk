 ...
 */
static __inline__ int string_toui(const char *nptr, int base, uint32_t *value)
{
    char *endptr = NULL;
    long int tmp_value;
...
static inline void hinic3_pmd_mml_log(char *show_str, int *show_len, const char *fmt, ...)
{
    va_list args;
    int ret = 0;
