...
static inline uint64_t hinic3_rx_rss_hash(uint32_t offload_type,
...
int hinic3_start_all_rqs(struct rte_eth_dev *eth_dev)
{
	...
	nic_dev = HINIC3_RTE_ETH_DEV_TO_PRIVATE_NIC_DEV(eth_dev);
