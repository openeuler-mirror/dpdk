...
static int get_dev_cap(struct hinic3_hwdev *hwdev)
{
...
static bool hinic3_support_nic(void *hwdev, struct nic_service_cap *cap)
{
...
static bool hinic3_func_for_mgmt(void *hwdev)
{
	struct hinic3_hwdev *dev = hwdev;
