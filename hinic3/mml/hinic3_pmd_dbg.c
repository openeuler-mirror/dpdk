...
int hinic3_dbg_get_sq_info(void *dev, u16 q_id,
...
int hinic3_dbg_get_sq_wqe_info(void *dev, u16 q_id, u16 idx, u16 wqebb_cnt, u8 *wqe, u16 *wqe_size)
{
    struct hinic3_hwdev *hwdev = (struct hinic3_hwdev *)dev;
    struct hinic3_nic_dev *nic_dev = (struct hinic3_nic_dev *)hwdev->dev_handle;
    struct hinic3_txq *txq = NULL;
...
int hinic3_dbg_get_rq_wqe_info(void *dev, u16 q_id, u16 idx, u16 wqebb_cnt, u8 *wqe, u16 *wqe_size)
{
    struct hinic3_hwdev *hwdev = (struct hinic3_hwdev *)dev;
    struct hinic3_nic_dev *nic_dev = (struct hinic3_nic_dev *)hwdev->dev_handle;
    struct hinic3_rxq *rxq = NULL;
