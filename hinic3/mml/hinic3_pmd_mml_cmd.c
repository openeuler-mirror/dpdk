...
static int
string_cmp(const char *command, const char *arguement)
{
...
void
major_command_option(major_cmd_t *major_cmd, const char *little, const char *large,
...
static int
major_cmd_repeat_option_set(major_cmd_t *major_cmd, const cmd_option_t *option, u32 *options_repeat_flag)
{
	int err;
...
void
command_parse(cmd_adapter_t *adapter, int argc, char **argv, void *buf_out, uint32_t *out_len)
{
	int i;
	major_cmd_t *major_cmd = NULL;
	char *arg = argv[1];
