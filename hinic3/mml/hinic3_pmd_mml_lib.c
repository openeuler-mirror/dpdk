...
static void fill_ioctl_msg_hd(struct msg_module *msg, unsigned int module,
...
static int lib_ioctl(struct msg_module *in_buf, void *out_buf)
{
...
int lib_rx_cqe_info_get(struct tool_target target, __rte_unused struct nic_rq_info *rq_info,
